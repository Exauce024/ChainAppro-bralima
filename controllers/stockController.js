...
class StockController {
  static async showStocks(req, res) {
    ...
    const stats = {
      ...
      stockCritique: stocks.filter(stock => stock.qtedisponible <= (stock.seuilcritique || 5)).length,
      stockAlerte: stocks.filter(stock => stock.qtedisponible <= (stock.seuilalerte || 10) && stock.qtedisponible > (stock.seuilcritique || 5)).length,
